...
{
    public class ReportPartyContact1Metadeta : TypeMetadataProvider<ReportPartyContact1>
    {
        public ReportPartyContact1Metadeta()
        {
            ...
            StringProperty(x => x.Name)
                .PersonalData(p=>p
                    .Searchable()
                    .IncludeInErasure(BWF.DataServices.Metadata.Fluent.Enums.PersonalDataErasureRule.Blank)
                    .IncludeInReport())
                .IsFreeFormat();
